...
import Proxy from 'src/proxies/UserProxy'
import UserTransformer from 'src/transformers/UserTransformer'
import PaginationTransformer from 'src/transformers/PaginationTransformer'
  ...
  await proxy.all()
    .then((response) => {
      const data = {
        ...
        pagination: PaginationTransformer.fetch(response.meta.pagination)
      }
